package project.app.BackgroundFrame.MainFrame.NavigationBar.ContactsButtonFrame.ContactsBackground;
...
public class ContactsBackground extends Rectangle
{
    public FillTransitionService EnterService, ExitService;

    public ContactsBackground()
    {
