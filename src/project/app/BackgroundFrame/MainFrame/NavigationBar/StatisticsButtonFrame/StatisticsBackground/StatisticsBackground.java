package project.app.BackgroundFrame.MainFrame.NavigationBar.StatisticsButtonFrame.StatisticsBackground;
...
public class StatisticsBackground extends Rectangle
{
    public FillTransitionService EnterService, ExitService;

    public StatisticsBackground()
    {
