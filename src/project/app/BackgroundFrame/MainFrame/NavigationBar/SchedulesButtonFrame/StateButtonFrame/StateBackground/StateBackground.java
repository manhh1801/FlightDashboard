package project.app.BackgroundFrame.MainFrame.NavigationBar.SchedulesButtonFrame.StateButtonFrame.StateBackground;
...
public class StateBackground extends Rectangle
{
    ...
    public StateBackground()
    {
        ...
        setWidth(40*UNIT); setHeight(30*UNIT);
    }
