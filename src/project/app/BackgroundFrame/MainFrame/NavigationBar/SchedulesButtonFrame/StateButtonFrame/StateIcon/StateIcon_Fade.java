package project.app.BackgroundFrame.MainFrame.NavigationBar.SchedulesButtonFrame.StateButtonFrame.StateIcon;
...
public class StateIcon_Fade extends Pane
{
    ...
    public StateIcon_Fade()
    {
        ...
        ClickOnService=new ParallelTransitionService(MidTranslateDown, new SequentialTransition(UpFadeIn, DownFadeOut));
