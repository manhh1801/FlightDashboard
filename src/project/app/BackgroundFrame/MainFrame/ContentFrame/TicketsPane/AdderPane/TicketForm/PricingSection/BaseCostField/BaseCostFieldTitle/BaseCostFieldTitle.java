package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PricingSection.BaseCostField.BaseCostFieldTitle;
...
public class BaseCostFieldTitle extends Text
{
    public FadeTransitionService TypingOnService, TypingOffService;

    public BaseCostFieldTitle()
    {
