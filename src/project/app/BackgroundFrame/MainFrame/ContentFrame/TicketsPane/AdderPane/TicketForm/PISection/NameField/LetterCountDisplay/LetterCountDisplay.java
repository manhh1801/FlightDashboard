package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PISection.NameField.LetterCountDisplay;
...
public class LetterCountDisplay extends Text
{
    ...
    public LetterCountDisplay()
    {
        ...
        setLayoutX(234.5*UNIT); setLayoutY(30*UNIT);
