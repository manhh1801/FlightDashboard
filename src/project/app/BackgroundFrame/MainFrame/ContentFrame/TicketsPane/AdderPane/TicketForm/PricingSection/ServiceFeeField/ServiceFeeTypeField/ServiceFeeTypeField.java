package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PricingSection.ServiceFeeField.ServiceFeeTypeField;
...
public class ServiceFeeTypeField extends TextField
{
    private final int MAX_LENGTH=8;

    public SimpleIntegerProperty LetterCount;

    public ServiceFeeTypeField()
    {
        setText("0");
        setPromptText("Service Fee");
