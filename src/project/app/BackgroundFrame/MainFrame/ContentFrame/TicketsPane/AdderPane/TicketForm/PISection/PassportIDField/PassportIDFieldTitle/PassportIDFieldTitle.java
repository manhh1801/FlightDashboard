package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PISection.PassportIDField.PassportIDFieldTitle;
...
public class PassportIDFieldTitle extends Text
{
    public FadeTransitionService TypingOnService, TypingOffService;

    public PassportIDFieldTitle()
    {
