package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.FlightRouteSection.FromField.FromFieldBackground;
...
public class FromFieldBackground extends Rectangle
{
    ...
    public FromFieldBackground()
    {
        ...
        setWidth(210*UNIT); setHeight(40*UNIT);
