package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PISection.PassportIDField.PassportIDFieldBackground;
...
public class PassportIDFieldBackground extends Pane
{
    public ParallelTransitionService TypingOnService, TypingOffService;

    public PassportIDFieldBackground()
    {
