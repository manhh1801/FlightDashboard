package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.FlightRouteSection.ToField.ToPicker.LocationContainer;
        ...
        (
            new EventHandler<MouseEvent>()
            {
                public void handle(MouseEvent m)
                {
                    ...
                    if((position>0)&&((position-(int)position)!=0)) {ToLocation.set(((ArrayList<Integer>)(LocationList.get())).get((int)position));}
                }
            }
        );
    }
