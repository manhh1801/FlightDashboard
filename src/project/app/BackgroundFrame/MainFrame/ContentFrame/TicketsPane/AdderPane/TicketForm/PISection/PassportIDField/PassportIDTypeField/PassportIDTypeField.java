package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PISection.PassportIDField.PassportIDTypeField;
...
public class PassportIDTypeField extends TextField
{
    private final int MAX_LENGTH=10;

    public SimpleIntegerProperty LetterCount;

    public PassportIDTypeField()
    {
        setPromptText("Passport ID");
        ...
        (
            new ChangeListener<String>()
            {
                ...
                {
                    if(NewValue.length()>MAX_LENGTH) {textProperty().set(OldValue);}
