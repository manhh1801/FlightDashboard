package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.AdderPane.TicketForm.PricingSection.BaseCostField.BaseCostFieldBackground;
...
public class BaseCostFieldBackground extends Pane
{
    public ParallelTransitionService TypingOnService, TypingOffService;

    public BaseCostFieldBackground()
    {
