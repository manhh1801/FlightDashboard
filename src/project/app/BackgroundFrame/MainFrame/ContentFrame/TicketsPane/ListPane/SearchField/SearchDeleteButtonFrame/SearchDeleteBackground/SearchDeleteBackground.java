package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.ListPane.SearchField.SearchDeleteButtonFrame.SearchDeleteBackground;
...
public class SearchDeleteBackground extends Rectangle
{
    public FillTransitionService EnterService, ExitService;

    public SearchDeleteBackground()
    {
        ...
        setFill(DARK_GRAY(0));
        setArcWidth(10*UNIT); setArcHeight(10*UNIT);
        setLayoutX(0); setLayoutY(0);
        setWidth(20*UNIT); setHeight(20*UNIT);
    }
