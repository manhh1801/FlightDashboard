package project.app.BackgroundFrame.MainFrame.ContentFrame.TicketsPane.ListPane.FilterSection.FilterItemsList.FilterItem.FilterItemName.RouteItemName;
...
public class RouteItemName_Fade extends Text
{
    ...
    public RouteItemName_Fade()
    {
        ...
        setLayoutX(0*UNIT); setLayoutY(5.5*UNIT);
        setEffect(new GaussianBlur(1*UNIT));
        setOpacity(0);
    }
